...
return new class extends Migration
{
    ...
    {
        DB::transaction(function (): void {
            foreach (DB::table('categories')->whereNotNull('parent_id')->orderBy('id')->get() as $subcategory) {
                DB::table('products')->where('category_id', $subcategory->id)->update(['category_id' => $subcategory->parent_id]);
            }
